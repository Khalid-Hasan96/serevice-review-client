      ...
      return (
            <div className='my-10'>
                  ...
                  <div className='mt-4 rounded-2xl p-10 sm:grid grid-cols-1 gap-5 lg:flex'>
                        ...
                        <form className='shadow-xl bg-yellow-400  bg-opacity-40  drop-shadow-lg p-5 w-full lg:w-1/2 lg:ml-5 rounded-xl'>
                              ...
                              <input type="submit" value="Submit" className='btn btn-warning hover:bg-yellow-500 ease-in duration-300 mt-2' />
                        </form>
                  </div>
            </div>
      );
